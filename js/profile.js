...
window.NexraProfile = (function () {
    ...
    function _subscribeAuth() {
        ...
        window.auth.onAuthStateChanged(function (user) {
            if (user) {
                ...
                // INTERCEPT & REDIRECT
                window.location.replace('/system/auth.html?redirect=/user/profile-dashboard.html');
            }
        });
    }
    ...
    function _bootDashboard() {
        ...
        _state.refUrl = window.location.origin + '/system/auth.html?ref=' + _state.currentUser.uid;
    ...
    function executeLogout() {
        ...
        window.auth.signOut().then(function() {
            window.location.replace('/system/auth.html');
        });
    }

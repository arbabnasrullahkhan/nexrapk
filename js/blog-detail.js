    ...
    function _injectSEO() {
        ...
        if (schemaEl) {
            schemaEl.textContent = JSON.stringify({
                ...
                "publisher": { "@type": "Organization", "name": "Nexra Tech PK", "logo": { "@type": "ImageObject", "url": (window.NexraBrand ? window.NexraBrand.getAsset('logo') : 'https://nexrapk.vercel.app/assets/logo.png') } },

    ...
    function _fetchLiveStats() {
        ...
        window.db.collection('stats').doc('live').get().then(function(doc) {
            ...
            var stats = [
                ...
                { icon: 'fa-handshake', number: data.activeResellers || 340, label: 'Reseller Partners', suffix: '+' },
    ...
    function _fetchTimeline() {
        ...
        window.db.collection('settings').doc('about').get().then(function(doc) {
            ...
            var milestones = doc.exists && doc.data().timeline ? doc.data().timeline : [
                ...
                { year: '2022', title: 'Marketplace Launch', desc: 'Full catalog launched with 50+ products and a reseller program.' },
                { year: '2023', title: 'VIP Ecosystem', desc: 'Diamond membership, giveaways, and affiliate systems deployed.' },

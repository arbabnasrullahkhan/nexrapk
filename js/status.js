...
window.NexraStatus = {
    ...
    defaultServices: [
        { id: 'api', name: 'Nexra Core API', desc: 'Main backend database and authentication.', status: 'operational' },
        { id: 'auth', name: 'Identity & Auth', desc: 'User login and session management.', status: 'operational' },
        { id: 'payment', name: 'Payment Gateway', desc: 'Transaction processing and wallet services.', status: 'operational' },
        { id: 'storage', name: 'Asset Delivery', desc: 'Base64 CDN and file rendering.', status: 'operational' }
    ],

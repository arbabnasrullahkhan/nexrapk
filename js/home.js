...
window.NexraHomeEngine = (function() {
    ...
    async function _renderCategories() {
        ...
        // Fallback categories
        const fallback = [
            { label: 'All',       icon: 'fa-border-all',       slug: '' },
            { label: 'SaaS',      icon: 'fa-cloud',            slug: 'saas' },
            { label: 'WordPress', icon: 'fa-wordpress-simple', slug: 'wordpress' },
            { label: 'Graphics',  icon: 'fa-palette',          slug: 'graphics' },
            { label: 'UI Kits',   icon: 'fa-layer-group',      slug: 'ui-kits' },
            { label: 'Courses',   icon: 'fa-graduation-cap',   slug: 'courses' },
            { label: 'AI Tools',  icon: 'fa-robot',            slug: 'ai-tools' },
            { label: 'SEO',       icon: 'fa-chart-line',       slug: 'seo' },
            { label: 'VPN / Sec', icon: 'fa-shield-halved',    slug: 'vpn' },
            { label: 'Gaming',    icon: 'fa-gamepad',          slug: 'gaming' },
        ];
    ...
    async function _renderTrending() {
        ...
        const fallback = [
            {
                id: 'capcut-pro',
                title: 'CapCut Pro Lifetime License',
                price: 950,
                oldPrice: 1800,
                image: 'https://i.postimg.cc/SNm7KsrH/images-(2).jpg',
                badge: 'SALE',
                badgeType: 'sale',
                rating: 5.0,
                soldCount: 3100,
            ...
            },
            {
                ...
                price: 450,
                oldPrice: 900,
                image: 'https://i.postimg.cc/Y25ZD1tW/images-(1).jpg',
                badge: 'HOT',
                badgeType: 'hot',
                rating: 5.0,
                soldCount: 5600,
            ...
            },
            {
                ...
                price: 1200,
                oldPrice: null,
                image: 'https://i.postimg.cc/fTHXTvkj/images.jpg',
                badge: 'NEW',
                badgeType: 'new',
                rating: 4.9,
                soldCount: 1200,
            ...
            {
                id: 'elementor-pro',
                title: 'Elementor Pro GPL Lifetime',
                price: 500,
                oldPrice: 1200,
                image: 'https://i.postimg.cc/prR8yGDh/images-(3).jpg',
                badge: 'SAAS',
                badgeType: 'saas',
                rating: 5.0,
                soldCount: 2800,
            ...
            {
                id: 'semrush-pro',
                title: 'SEMrush Pro Account 1 Month',
                price: 1500,
                oldPrice: 3000,
                image: 'https://i.postimg.cc/Y25ZD1tW/images-(1).jpg',
                badge: 'HOT',
            ...
            {
                id: 'grammarly-pro',
                title: 'Grammarly Premium 1 Year',
                price: 700,
                oldPrice: 1400,
                image: 'https://i.postimg.cc/fTHXTvkj/images.jpg',
                badge: 'SALE',
            ...
            {
                id: 'adobe-cc',
                title: 'Adobe Creative Cloud Plan',
                price: 2000,
                oldPrice: 4500,
                image: 'https://i.postimg.cc/prR8yGDh/images-(3).jpg',
                badge: 'VIP',
        ...
        const fallback = [
            {
                ...
                sub: 'Figma + HTML · 24 Screens · 120+ Components',
                image: 'https://i.postimg.cc/prR8yGDh/images-(3).jpg',
                locked: false,
            },
            {
                id: 'agency-portfolio-template',
                cat: 'TEMPLATE',
                title: 'Agency Portfolio Webflow Template',
                sub: 'Full Webflow Clone · 8 Pages · Mobile Ready',
                image: 'https://i.postimg.cc/Y25ZD1tW/images-(1).jpg',
                locked: true,
            },
            {
                id: 'freelancing-guide-pk',
                cat: 'GUIDE',
                title: 'Pakistan Freelancing Starter Guide 2025',
                sub: 'PDF · 60 Pages · Urdu + English',
                image: 'https://i.postimg.cc/fTHXTvkj/images.jpg',
                locked: false,
            },
        ];
    ...
    async function _renderBlogs() {
        ...
        const fallback = [
            {
                id: 'saas-reselling-agency-pk',
                cat: 'GUIDES',
                title: 'How to Start Your SaaS Reselling Agency in Pakistan in 2025',
                date: 'June 2025',
                readMin: 8,
                image: 'https://i.postimg.cc/SNm7KsrH/images-(2).jpg',
            },
            {
                id: 'elementor-gpl-profit-margins',
                cat: 'TUTORIALS',
                title: 'Maximizing Profit Margins with Elementor GPL & Reseller Pricing',
                date: 'June 2025',
                readMin: 6,
                image: 'https://i.postimg.cc/Y25ZD1tW/images-(1).jpg',
            },
            {
                id: 'chatgpt-vs-claude-2025',
                cat: 'NEWS',
                title: 'ChatGPT Plus vs Claude 3.5: Which AI Tool is Worth Buying in 2025?',
                date: 'May 2025',
                readMin: 5,
                image: 'https://i.postimg.cc/fTHXTvkj/images.jpg',
            },
    ...
    async function _renderMarquee() {
        ...
        const fallback = [
            { name: 'Ali R.',    loc: 'Lahore',     text: '"Instant delivery. Been buying Canva Pro for 6 months — never had an issue. 100% legit."', rating: 5, verified: true },
            { name: 'Sara K.',   loc: 'Karachi',    text: '"The free vault alone is worth visiting every single day. Unreal value for free resources."', rating: 5, verified: true },
            { name: 'Usman T.',  loc: 'Islamabad',  text: '"Started my agency using their reseller bundle. Made my first Rs. 50K in month one!"', rating: 5, verified: true },
            { name: 'Zainab M.', loc: 'Faisalabad', text: '"Best customer support in Pakistan. Fixed my CapCut Pro issue in under 5 minutes. WOW!"', rating: 5, verified: true },
            { name: 'Hamza B.',  loc: 'Peshawar',   text: '"ChatGPT Plus for Rs. 1200 is a steal. 100% legit, use it daily for my freelancing work."', rating: 5, verified: true },
            { name: 'Fatima N.', loc: 'Multan',     text: '"Nexra is literally the Amazon of digital tools for Pakistan. No cap, genuinely."', rating: 5, verified: true },
            { name: 'Bilal S.',  loc: 'Rawalpindi', text: '"Super fast delivery and genuine keys. Bought SEMrush Pro and it activated immediately."', rating: 5, verified: true },
            { name: 'Amna Q.',   loc: 'Lahore',     text: '"The VIP membership discount pays for itself in one purchase. Highly recommend upgrading!"', rating: 5, verified: false },
        ];
    ...
    /* =====================================================================
       SEARCH
       Live: dropdown results on keyup (Firestore products keywords[])
       Full: navigate to shop page with ?search= on submit/Enter
       ===================================================================== */

    /**
     * Execute full product search — navigate to shop page.

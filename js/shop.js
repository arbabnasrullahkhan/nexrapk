...
window.NexraShopEngine = (function () {
    ...
    // Expose for onclick
    window.NexraShopEngine._selectCategory = _selectCategory;
    ...
    window.NexraShopEngine._bannerCTA = _bannerCTA;
    ...
    window.NexraShopEngine._setSort = _setSort;
    ...
    window.NexraShopEngine._toggleTypeFilter = _toggleTypeFilter;
    ...
    window.NexraShopEngine._removeChip = _removeChip;
    ...
    window.NexraShopEngine._buyNow = _buyNow;
        ...
        try {
            ...
            listEntry.itemListElement = products.slice(0, 10).map(function (p, idx) {
                return {
                    '@type':    'ListItem',
                    'position': idx + 1,
                    'url':      (window.NexraRoutes ? window.NexraRoutes.baseUrl : 'https://nexrapk.vercel.app') + '/shop/product-detail.html?id=' + p.id,
                    'name':     p.title || '',
                    'item': {
                        '@type':       'Product',
                        'name':        p.title || '',
